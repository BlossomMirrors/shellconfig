...
export GUM_CHOOSE_SELECTED_FOREGROUND="#FFFFFF"
export GUM_CHOOSE_SELECTED_BACKGROUND="#5555FF"
export GUM_CHOOSE_HEADER_FOREGROUND="#AAAAFF"
export GUM_CHOOSE_ITEM_FOREGROUND="#AAAAFF"
...
export GUM_CONFIRM_UNSELECTED_FOREGROUND="#FFFFFF"
export GUM_CONFIRM_UNSELECTED_BACKGROUND="#3333AA"
